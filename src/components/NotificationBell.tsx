      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed sm:absolute right-4 sm:right-0 left-4 sm:left-auto top-14 sm:top-full sm:mt-2 w-auto sm:w-80 rounded-xl border border-border bg-card shadow-xl z-50 overflow-hidden"
          >
            {/* Header */}
