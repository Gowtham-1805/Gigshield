      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 sm:right-0 top-full mt-2 w-[calc(100vw-2rem)] sm:w-80 max-w-80 rounded-xl border border-border bg-card shadow-xl z-50 overflow-hidden -right-2"
          >
            {/* Header */}
